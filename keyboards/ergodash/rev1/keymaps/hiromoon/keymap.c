...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | Bksp|                    | Enter|   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Pscree |  GUI |  ALt | EISU |||||||| GUI | LOWER |  Space |||||||| Bksp | Enter| GUI|||||||| Kana | Raise |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_PSCR, KC_LGUI, KC_LALT, KC_LANG2,         KC_LGUI,   LOWER, KC_SPC,        KC_BSPC, KC_ENT , KC_RGUI,          KC_LANG1, RAISE, KC_UP,   KC_RGHT  \
  ),

  /* Lower
   * ,----------------------------------------------------------------------------------------------------------------------.
   * |  F11 |  F1  |  F2  |  F3  |  F4  |  F5  |   (  |                    |   )  |  F6  |  F7  |  F8  |  F9  |  -   |  =   |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * |  ~   |   !  |   @  |   #  |   $  |   %  |   _  |                    |   +  |   ^  |PageUp|   *  |   {  |   }  |  |   |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | Tab  |   1  |   2  |PageDn|   4  |   5  |  Del |                    | Bksp | Left | Down |  UP  | Right |   :  |  "   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   ...
   */
  [_LOWER] = LAYOUT(
    KC_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_LPRN,                        KC_RPRN, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_MINS,  KC_EQL,  \
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_UNDS,                        KC_PLUS, KC_CIRC, KC_PGUP, KC_ASTR, KC_LCBR, KC_RCBR, KC_PIPE, \
    KC_TAB,  KC_1,    KC_2,    KC_PGDN,    KC_4,    KC_5,    KC_DEL ,                        KC_BSPC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_COLN, KC_DQT , \
