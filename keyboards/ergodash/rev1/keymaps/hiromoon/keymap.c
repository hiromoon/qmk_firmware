...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Pscree |  GUI |  ALt | EISU |||||||| GUI | LOWER |  Bksp |||||||| Space | Enter| GUI|||||||| Kana | Raise |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_PSCR, KC_LGUI, KC_LALT, KC_LANG2,         KC_LGUI,   LOWER, KC_BSPC,        KC_SPC, KC_ENT , KC_RGUI,          KC_LANG1, RAISE, KC_UP,   KC_RGHT  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_UNDS,                        KC_PLUS, KC_CIRC, KC_PGUP, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE, \
